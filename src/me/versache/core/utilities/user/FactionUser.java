...
public class FactionUser implements ConfigurationSerializable {
	...
	public FactionUser(Map<String, Object> map) {
		...
		this.deathban = (me.versache.core.hcf.deathban.Deathban) map.get("deathban");
	...
	public void setDeathban(final me.versache.core.hcf.deathban.Deathban deathban2) {
		this.deathban = deathban2;
	}
