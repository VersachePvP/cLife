...
public class PlayerBoard {
	...
	public PlayerBoard(Base plugin, Player player) {
		...
		this.neutrals.setPrefix(ChatColor.DARK_RED + ChatColor.ITALIC.toString());

		(this.archers = this.scoreboard.registerNewTeam("archers")).setPrefix(ChatColor.GOLD + ChatColor.ITALIC.toString());
