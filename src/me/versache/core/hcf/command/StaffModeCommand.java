...
import me.versache.core.hcf.staffmode.StaffItems;
...
public class StaffModeCommand implements Listener, CommandExecutor {
	...
	public static boolean enterMod(final Player p) {
		...
		p.sendMessage(ConfigurationService.SECONDARY_COLOR + "You have " + ChatColor.GREEN + "enabled " + ConfigurationService.SECONDARY_COLOR  + "your " + ConfigurationService.PRIMARY_COLOR + ChatColor.BOLD + "Staff Mode");
		return true;
	}
	...
	public static boolean leaveMod(final Player p) {
		...
		p.sendMessage(ConfigurationService.SECONDARY_COLOR + "You have " + ChatColor.RED + "disabled " + ConfigurationService.SECONDARY_COLOR  + "your " + ConfigurationService.PRIMARY_COLOR + ChatColor.BOLD + "Staff Mode");
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if (cmd.getName().equalsIgnoreCase("staffmode")) {
			...
			if (modMode.contains(t)) {
				leaveMod(t);
				sender.sendMessage(ConfigurationService.SECONDARY_COLOR + "You have " + ChatColor.GREEN + "disabled " + ConfigurationService.SECONDARY_COLOR + t.getName() + "'s " + ConfigurationService.PRIMARY_COLOR + ChatColor.BOLD + "Staff Mode");
				return true;
			}
			enterMod(t);
