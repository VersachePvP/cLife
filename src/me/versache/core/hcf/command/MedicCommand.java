...
public class MedicCommand implements CommandExecutor {
	...
	public MedicCommand(final Base plugin) {
		this.plugin = plugin;
	}
	...
	public boolean onCommand(final CommandSender sender, final Command command, final String label,
		...
		Bukkit.broadcastMessage(ChatColor.GOLD + sender.getName() + ChatColor.YELLOW + " has revived " + ChatColor.GOLD + target.getName() + ChatColor.YELLOW + " with their top rank.");
		Cooldowns.addCooldown("emerald", player, 3600);
