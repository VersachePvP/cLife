...
public class RenameCommand extends BaseCommand {
    ...
    static {
        DISALLOWED = Arrays.asList("hitler", "key", "Key", "\u534d", "jews", "nigger", "n1gger", "brouard", "ddos", "nigga", "dox", "kys", "leaked", "shit staff", "my server", "join my server", "customkkk", "Niqqer", "Hitler", "9/ll", "911");
    }
