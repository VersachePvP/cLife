...
public class GameModeCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		Command.broadcastCommandMessage(sender, ConfigurationService.SECONDARY_COLOR + "Set gamemode of " + ConfigurationService.PRIMARY_COLOR + target.getName() + ConfigurationService.SECONDARY_COLOR + " to " + ConfigurationService.PRIMARY_COLOR + mode.name() + ConfigurationService.SECONDARY_COLOR + '.');
		return true;
	}
