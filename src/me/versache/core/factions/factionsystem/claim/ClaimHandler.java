package me.versache.core.factions.factionsystem.claim;
...
import me.versache.core.factions.factionsystem.type.WildernessFaction;
import me.versache.core.utilities.util.ItemBuilder;
...
public class ClaimHandler {
    ...
    static {
        CLAIM_WAND = new ItemBuilder(Material.GOLD_AXE).displayName(ChatColor.GOLD + ChatColor.BOLD.toString() + "Claiming Wand").lore(new String[]{"" + ChatColor.YELLOW + "Left or Right Click " + ChatColor.GOLD + "a Block" + ChatColor.YELLOW + " to:", ChatColor.GRAY + "Set the first and second position of ", ChatColor.GRAY + "your Claim selection.", "", ChatColor.YELLOW + "Right Click " + ChatColor.GOLD + "the Air" + ChatColor.YELLOW + " to:", ChatColor.GRAY + "Clear your current Claim selection.", "", ChatColor.YELLOW + "Shift " + ChatColor.YELLOW + "Left Click " + ChatColor.GOLD + "the Air or a Block" + ChatColor.YELLOW + " to:", ChatColor.GRAY + "Purchase your current Claim selection."}).build();
    }
